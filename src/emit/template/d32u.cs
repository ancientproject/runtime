namespace ancient.runtime.emit.@unsafe
{
    ...
    public class d32i : UnsafeDeconstruct<int>
    {
        public d32i(int value) : base(value) { }
        ...
        public d32i Construct(in byte n1, in byte n2, in byte n3, in byte n4, in byte n5, in byte n6, in byte n7, in byte n8)
        {
            resetShifter();
            _value = (
                (n1 << shift()) | 
        ...
        public static implicit operator (byte n1, byte n2, byte n3, byte n4, byte n5, byte n6, byte n7, byte n8)(d32i u) => u.Deconstruct();
        public static implicit operator d32i((byte n1, byte n2, byte n3, byte n4, byte n5, byte n6, byte n7, byte n8) u) => new d32i(0).Construct(u.n1, u.n2, u.n3, u.n4, u.n5, u.n6, u.n7, u.n8);

        public static implicit operator int(d32i u) => u.Value;
    }
}